...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[479],
	{
		...
		4479: (e, t, n) => {
			...
			function c() {
				return (
					(null === u || !0 === u.buffer.detached || (void 0 === u.buffer.detached && u.buffer !== r.memory.buffer)) &&
			...
			function l(e, t) {
				return ((e >>>= 0), f.decode(a().subarray(e, e + t)));
			}
			function w(e, t) {
			...
			function s(e) {
				(w(e, I), r.grayscale(e.__wbg_ptr));
			}
			function d(e) {
				(w(e, I), r.golden(e.__wbg_ptr));
			}
			function h(e, t) {
				let n = t(+e.length, 1) >>> 0;
				return (a().set(e, n / 1), (_ = e.length), n);
			}
			function m(e, t) {
			...
			class I {
				...
				constructor(e, t, n) {
					let i = h(e, r.__wbindgen_malloc),
						a = _,
						o = r.photonimage_new(i, a, t, n);
					return ((this.__wbg_ptr = o >>> 0), C.register(this, this.__wbg_ptr, this), this);
				}
				static new_from_base64(e) {
					let t = b(e, r.__wbindgen_malloc, r.__wbindgen_realloc),
						n = _,
						i = r.base64_to_image(t, n);
					return I.__wrap(i);
				}
				static new_from_byteslice(e) {
					let t = h(e, r.__wbindgen_malloc),
						n = _,
				...
				let o = (function () {
					...
					return (
						...
						(e.wbg.__wbg_stack_658279fe44541cf6 = function (e, t) {
							let n = b(t.stack, r.__wbindgen_malloc, r.__wbindgen_realloc),
								i = _;
						...
						(e.wbg.__wbg_data_fda507064d127f5b = function (e, t) {
							let n = h(t.data, r.__wbindgen_malloc),
								i = _;
							(c().setInt32(e + 4, i, !0), c().setInt32(e + 0, n, !0));
						}),
						(e.wbg.__wbg_newwithu8clampedarrayandsh_1fddccb3a94a5e05 = function () {
							return x(function (e, t, n, _) {
								var i;
								return new ImageData(
									((i = e >>> 0),
									((null === v || 0 === v.byteLength) && (v = new Uint8ClampedArray(r.memory.buffer)), v).subarray(
										i / 1,
										i / 1 + t,
									)),
									n >>> 0,
						...
						(e.wbg.__wbg_drawImage_f395c8e43c79a909 = function () {
							return x(function (e, t, n, r, _, i, a, o, g, b) {
								e.drawImage(t, n, r, _, i, a, o, g, b);
							}, arguments);
						}),
						(e.wbg.__wbg_getImageData_5e1c242046e6b59e = function () {
							return x(function (e, t, n, r, _) {
								return e.getImageData(t, n, r, _);
							}, arguments);
						}),
						...
						(e.wbg.__wbindgen_debug_string = function (e, t) {
							let n = b(
									(function e(t) {
										...
										if (!(_.length > 1)) return toString.call(t);
										if ('Object' == (n = _[1]))
											try {
...
${t.stack}`
				...
				('string' == typeof e ||
					...
					(e = fetch(e));
				let { instance: g, module: f } = await A(await e, o);
				return (
					(t = g),
					(a = f),
					(r = t.exports),
