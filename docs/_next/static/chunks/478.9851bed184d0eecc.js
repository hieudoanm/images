...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
	[478],
	{
		1133: (e, t, s) => {
			s.d(t, { RG: () => n });
			let l = (e) => {
					let { content: t, format: s, filename: l } = e,
						r = encodeURI(t),
						a = document.createElement('a');
					a.setAttribute('href', r);
					let n = new Date(),
						o = n.getTimezoneOffset(),
						[c, d] = new Date(n.getTime() + -((o / 60) * 36e5)).toISOString().split('T'),
						[i] = d.split(':').join('-').split('.'),
						x = ''.concat(l, '-').concat(c, '-').concat(i, '.').concat(s);
					(a.setAttribute('download', x), document.body.append(a), a.click(), a.remove());
				},
				r = (e) => {
					let { content: t, format: s, filename: r } = e;
					l({ content: 'data:text/'.concat(s, ';charset=utf-8,').concat(t), format: s, filename: r });
				},
				a = (e) => {
					let { content: t, format: s, filename: r } = e;
					l({ content: t, format: s, filename: r });
				},
				n = (e) => {
					let { content: t, format: s, filename: l } = e;
					return {
						image: () => a({ content: t, format: s, filename: l }),
						text: () => r({ content: t, format: s, filename: l }),
					};
				};
		},
		2635: (e, t, s) => {
					...
					children: (0, l.jsxs)('div', {
						...
						children: [
							(0, l.jsx)('h3', {
								...
								children: 'Why Use Our QR Code Generator?',
							}),
							(0, l.jsx)('p', {
							...
							(0, l.jsxs)('div', {
								...
								children: [
									...
									(0, l.jsxs)('div', {
										className: 'rounded-xl border border-neutral-800 p-6 shadow-sm',
										children: [
											(0, l.jsx)('h4', { className: 'text-lg font-semibold', children: '⚡ Instant Generation' }),
											(0, l.jsx)('p', {
												className: 'mt-2 text-sm text-neutral-500',
												children: 'Generate high-quality QR codes in real time without downloads or delays.',
											}),
										],
									}),
									(0, l.jsxs)('div', {
										...
										children: [
											(0, l.jsx)('h4', {
												className: 'text-lg font-semibold',
												children: '\uD83C\uDFAF Customizable Output',
											}),
											(0, l.jsx)('p', {
												className: 'mt-2 text-sm text-neutral-500',
												children: 'Customize colors, size, error correction levels, and more to fit your exact needs.',
											}),
										],
									}),
								],
			...
			let x = () =>
					(0, l.jsx)('footer', {
						...
						children: (0, l.jsxs)('div', {
							...
							children: [
								(0, l.jsxs)('p', { children: ['\xa9 ', new Date().getFullYear(), ' ', c.C, '. All rights reserved.'] }),
								(0, l.jsx)('div', {
									className: 'space-x-4',
									children: (0, l.jsx)(i(), {
				...
				m = () =>
					(0, l.jsx)('header', {
						...
						children: (0, l.jsxs)('div', {
							...
							children: [
								(0, l.jsx)(i(), { href: '/', children: (0, l.jsx)('h1', { className: 'font-black', children: c.C }) }),
								(0, l.jsx)('nav', {
				...
				u = () => {
					let [{ dataURL: e = '', url: t = 'https://google.com' }, s] = (0, n.useState)({
							dataURL: '',
							url: 'https://google.com',
						}),
						c = async () => {
							let e = await (0, a.dY)(t, {
					...
					return (0, l.jsxs)(l.Fragment, {
						children: [
							...
							(0, l.jsx)('section', {
								...
								children: (0, l.jsxs)('div', {
									...
									children: [
										...
										(0, l.jsxs)('div', {
											className:
												'flex w-full justify-center gap-4 gap-x-4 rounded-full bg-neutral-100 px-4 py-2 text-neutral-900',
											children: [
												(0, l.jsx)('input', {
													id: 'url',
													name: 'url',
											...
											children: (0, l.jsxs)('div', {
												...
												children: [
													(0, l.jsx)('h3', {
														...
														children: 'Ready to generate your QR code?',
													}),
													(0, l.jsx)('p', {
							...
							e &&
								(0, l.jsxs)('div', {
									className: 'mx-auto flex w-full max-w-3xl flex-col gap-y-8 p-8',
									children: [
										(0, l.jsx)('button', {
											type: 'button',
											className: 'cursor-pointer rounded-full bg-neutral-100 px-4 py-2 text-neutral-900',
											onClick: () => {
												(0, r.RG)({ content: e, format: 'jpg', filename: 'qrcode' }).image();
											},
											children: 'Download',
										}),
										(0, l.jsx)('div', {
											className:
												'aspect-square w-full overflow-hidden rounded-2xl border border-neutral-800 bg-contain bg-center bg-no-repeat',
