	...
	[739],
	{
			...
			((e.isValid = function (t) {
				...
				(e.getPenaltyN1 = function (t) {
					...
					for (let u = 0; u < e; u++) {
						...
						for (let l = 0; l < e; l++) {
							let e = t.get(u, l);
							(e === a ? o++ : (o >= 5 && (n += r.N1 + (o - 5)), (a = e), (o = 1)),
								(e = t.get(l, u)) === s ? i++ : (i >= 5 && (n += r.N1 + (i - 5)), (s = e), (i = 1)));
						}
			...
			var e = {
				single_source_shortest_paths: function (t, r, n) {
					...
					for (g.push(r, 0); !g.empty(); )
						for (a in ((i = (o = g.pop()).value), (s = o.cost), (u = t[i] || {})))
							u.hasOwnProperty(a) &&
								((l = s + u[a]), (f = c[a]), (void 0 === c[a] || f > l) && ((c[a] = l), g.push(a, l), (h[a] = i)));
					if (void 0 !== n && void 0 === c[n]) throw Error(['Could not find a path from ', r, ' to ', n, '.'].join(''));
					return h;
				},
		...
		3185: (t, e, r) => {
			...
			e.create = function (t, e) {
				...
				return (
					void 0 !== e &&
						((E = o.from(e.errorCorrectionLevel, o.M)),
						(r = c.from(e.version)),
						(g = l.from(e.maskPattern)),
					...
					(function (t, e, r, o) {
						...
						let E = c.getBestVersionForData(g, r);
						...
						let y = (function (t, e, r) {
								let o = new i();
								r.forEach(function (e) {
									(o.put(e.mode.bit, 4), o.put(e.getLength(), d.getCharCountIndicator(e.mode, t)), e.write(o));
								});
								let a = (n.getSymbolTotalCodewords(t) - f.getTotalCodewordsCount(t, e)) * 8;
								...
								return (function (t, e, r) {
									let o,
										...
										s = a - f.getTotalCodewordsCount(e, r),
										u = f.getBlocksCount(e, r),
										l = a % u,
										c = u - l,
										g = Math.floor(a / u),
										d = Math.floor(s / u),
									...
									for (let t = 0; t < u; t++) {
										let e = t < c ? d : p;
										((w[t] = N.slice(y, y + e)), (A[t] = E.encode(w[t])), (y += e), (C = Math.max(C, e)));
									}
									let B = new Uint8Array(a),
										I = 0;
									for (o = 0; o < C; o++) for (i = 0; i < u; i++) o < w[i].length && (B[I++] = w[i][o]);
									for (o = 0; o < m; o++) for (i = 0; i < u; i++) B[I++] = A[i][o];
									return B;
								})(o, t, e);
							})(e, r, g),
							w = new a(n.getSymbolSize(e));
						!(function (t, e) {
							let r = t.size,
								n = u.getPositions(e);
						...
						return (
							...
							isNaN(o) && (o = l.getBestMask(w, m.bind(null, w, r))),
							l.applyMask(o, w),
							m(w, r, o),
							{ modules: w, version: e, errorCorrectionLevel: r, maskPattern: o, segments: g }
						);
					})(t, r, E, g)
				);
			};
		...
		3739: (t, e, r) => {
			...
			function s(t, e, r, i, a) {
				...
				if (!l && !n()) throw Error('Callback required as last argument');
				if (l) {
					if (u < 2) throw Error('Too few arguments provided');
					2 === u
						? ((a = r), (r = e), (e = i = void 0))
						: 3 === u &&
							(e.getContext && void 0 === a ? ((a = i), (i = void 0)) : ((a = i), (i = r), (r = e), (e = void 0)));
				} else {
					if (u < 1) throw Error('Too few arguments provided');
					return (
						1 === u ? ((r = e), (e = i = void 0)) : 2 !== u || e.getContext || ((i = r), (r = e), (e = void 0)),
			...
			(o.create,
				...
				(e.dY = s.bind(null, i.renderToDataURL)),
				s.bind(null, function (t, e, r) {
					return a.render(t, r);
				}));
		},
		4325: (t, e) => {
		...
		4706: (t, e, r) => {
			...
			e.render = function (t, e, r) {
				let a = n.getOptions(e),
					...
					u = t.modules.data,
					l = s + 2 * a.margin,
					f = a.color.light.a ? '<path ' + o(a.color.light, 'fill') + ' d="M0 0h' + l + 'v' + l + 'H0z"/>' : '',
					h =
						'<path ' +
						...
						(function (t, e, r) {
							...
							for (let u = 0; u < t.length; u++) {
								let l = Math.floor(u % e),
									f = Math.floor(u / e);
								(l || a || (a = !0),
									t[u]
										? (s++,
											(u > 0 && l > 0 && t[u - 1]) ||
												((n += a ? i('M', l + r, 0.5 + f + r) : i('m', o, 0)), (o = 0), (a = !1)),
											(l + 1 < e && t[u + 1]) || ((n += i('h', s)), (s = 0)))
										: o++);
							}
							return n;
						})(u, s, a.margin) +
		...
		5681: (t, e, r) => {
			...
			function g(t) {
				let e,
					r,
					o = c(u.NUMERIC, n.NUMERIC, t),
					i = c(u.ALPHANUMERIC, n.ALPHANUMERIC, t);
				return (
			...
			function p(t, e) {
				...
				if ((r = n.from(e, u)) !== n.BYTE && r.bit < u.bit)
					throw Error(
						'"' + t + '" cannot be encoded with mode ' + n.toString(r) + '.\n Suggested mode is: ' + n.toString(u),
					);
				switch ((r === n.KANJI && !l.isKanjiModeEnabled() && (r = n.BYTE), r)) {
					case n.NUMERIC:
						return new o(t);
					case n.ALPHANUMERIC:
						return new i(t);
					...
					let o = (function (t, e) {
							...
							for (let a = 0; a < t.length; a++) {
								...
								for (let t = 0; t < s.length; t++) {
									let l = s[t],
										f = '' + a + t;
									(u.push(f), (r[f] = { node: l, lastCount: 0 }), (o[f] = {}));
									for (let t = 0; t < i.length; t++) {
										let a = i[t];
										r[a] && r[a].node.mode === l.mode
											? ((o[a][f] = d(r[a].lastCount + l.length, l.mode) - d(r[a].lastCount, l.mode)),
												(r[a].lastCount += l.length))
											: (r[a] && (r[a].lastCount = l.length),
												(o[a][f] = d(l.length, l.mode) + 4 + n.getCharCountIndicator(l.mode, e)));
									}
								}
								i = u;
							}
		...
		5937: (t, e, r) => {
			...
			((o.getBitsLength = function (t) {
				...
				(o.prototype.write = function (t) {
					...
					o > 0 && ((n = parseInt(this.data.substr(e), 10)), t.put(n, 3 * o + 1));
				}),
				(t.exports = o));
		},
		8786: (t, e) => {
		...
		9295: (t, e, r) => {
			...
			((e.getRowColCoords = function (t) {
				...
				(e.getPositions = function (t) {
					...
					for (let t = 0; t < o; t++)
						for (let e = 0; e < o; e++)
							(0 !== t || 0 !== e) && (0 !== t || e !== o - 1) && (t !== o - 1 || 0 !== e) && r.push([n[t], n[e]]);
					return r;
				}));
		},
		9767: (t, e) => {
					...
					for (let e = 0; e < s; e++)
						for (let r = 0; r < s; r++) {
							...
							(e >= u &&
								...
								e < s - u &&
								r < s - u &&
								(h = l[+!!i[Math.floor((e - u) / a) * o + Math.floor((r - u) / a)]]),
								(t[f++] = h.r),
								(t[f++] = h.g),
								(t[f++] = h.b),
								(t[f] = h.a));
